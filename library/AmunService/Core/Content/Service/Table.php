...
/**
 * AmunService_Core_Content_Service_Table
 *
 ...
 */
class AmunService_Core_Content_Service_Table extends Amun_Sql_TableAbstract
{
	...
	{
		return $this->registry['table.core_content_service'];
	}
