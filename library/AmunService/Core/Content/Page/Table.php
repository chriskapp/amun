 ...
 */
class AmunService_Core_Content_Page_Table extends Amun_Sql_TableAbstract
{
	public function getConnections()
	{
		return array(

			'parentId' => $this->registry['table.core_content_page'],
			'serviceId' => $this->registry['table.core_content_service'],
	...
	{
		return $this->registry['table.core_content_page'];
	}
