...
/**
 * AmunService_Core_Content_Page_Right_Handler
 *
 ...
 */
class AmunService_Core_Content_Page_Right_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('pageId', 'groupId', 'newGroupId'))
		{
