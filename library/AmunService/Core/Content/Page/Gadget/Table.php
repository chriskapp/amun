 ...
 */
class AmunService_Core_Content_Page_Gadget_Table extends Amun_Sql_TableAbstract
{
	public function getConnections()
	{
		return array(
			...
			'gadgetId' => $this->registry['table.core_content_gadget'],
	...
	{
		return $this->registry['table.core_content_page_gadget'];
	}
