 ...
 */
class AmunService_Core_User_Group_Right_Form extends Amun_Data_FormAbstract
{
	...
	{
		$record = Amun_Sql_Table_Registry::get('Core_User_Group_Right')->getRecord($id);
	...
	{
		$right  = array();
		$result = $this->sql->getAll('SELECT id, description FROM ' . $this->registry['table.core_user_right'] . ' ORDER BY description ASC');
