 ...
 */
class AmunService_Core_User_Group_Form extends Amun_Data_FormAbstract
{
	...
	{
		$record = Amun_Sql_Table_Registry::get('Core_User_Group')->getRecord($id);
