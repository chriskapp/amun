...
/**
 * AmunService_Core_System_Api_Request_Table
 *
 ...
 */
class AmunService_Core_System_Api_Request_Table extends Amun_Sql_TableAbstract
{
	public function getConnections()
	{
		return array(

			'apiId' => $this->registry['table.core_system_api'],
	...
	{
		return $this->registry['table.core_system_api_request'];
	}
