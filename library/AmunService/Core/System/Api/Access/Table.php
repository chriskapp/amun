...
/**
 * AmunService_Core_System_Api_Access_Table
 *
 ...
 */
class AmunService_Core_System_Api_Access_Table extends Amun_Sql_TableAbstract
{
	...
	{
		return $this->registry['table.core_system_api_access'];
	}
