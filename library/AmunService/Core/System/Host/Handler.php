 ...
 */
class AmunService_Core_System_Host_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('status', 'name', 'consumerKey', 'consumerSecret', 'url'))
		{
