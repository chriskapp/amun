 ...
 */
class AmunService_Core_System_Registry_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('name', 'value'))
		{
