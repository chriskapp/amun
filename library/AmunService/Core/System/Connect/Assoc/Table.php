...
/**
 * Amun_System_Connect_Assoc_Table
 *
 ...
 */
class AmunService_Core_System_Connect_Assoc_Table extends Amun_Sql_TableAbstract
{
	...
	{
		return $this->registry['table.core_system_connect_assoc'];
	}
