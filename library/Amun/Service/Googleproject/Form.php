...
/**
 * Amun_Service_Googleproject_Form
 *
 ...
 */
class Amun_Service_Googleproject_Form extends Amun_Data_FormAbstract
{
	public function create($pageId = 0)
	{
		...
		$secret = new Amun_Form_Element_Input('secret', 'Secret');
		$secret->setType('text');
	...
	public function update($id)
	{
		...
		$secret = new Amun_Form_Element_Input('secret', 'Secret', $record->secret);
		$secret->setType('text');
