 ...
 */
class Amun_Service_Googleproject_Author_Form extends Amun_Data_FormAbstract
{
	...
	{
		$record = Amun_Sql_Table_Registry::get('Service_Googleproject_Author')->getRecord($id);
