<?php
/*
 *  $Id: Form.php 714 2012-06-18 22:23:51Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Php_Form extends Amun_Data_FormAbstract
{
	public function create($pageId = 0)
	{
		...
		$panel = new Amun_Form_Element_Panel('php', 'Php');
	...
	{
		$record = Amun_Sql_Table_Registry::get('Service_Php')->getRecord($id);
