 ...
 */
class Amun_Content_Service_Form extends Amun_Data_FormAbstract
{
	...
	{
		$services          = array();
		$installedServices = $this->sql->getCol('SELECT name FROM ' . $this->registry['table.content_service']);
