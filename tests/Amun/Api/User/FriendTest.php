<?php
/*
 *  $Id: FriendTest.php 637 2012-05-01 19:58:47Z k42b3.x@googlemail.com $
 *
 * amun
...
class FriendTest extends RestTest
{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/user/friend';
	}
	...
	public function testPost()
	{
		...
		$record->setFriendId(2);

		$this->assertPositiveResponse($this->post($record));

		$actual = $this->table->getRow(array('friendId'), new Condition(array('id', '=', 3)));
	...
	public function testPut()
	{
		...
		$actual = $this->table->getRow(array('id', 'friendId'), new Condition(array('id', '=', 1)));
		$expect = array_map('strval', $record->getData());
