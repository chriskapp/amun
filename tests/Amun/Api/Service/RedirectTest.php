 ...
 */
class Amun_Api_Service_RedirectTest extends Amun_Api_RestTest
{
	protected function setUp()
	{
		if(!Amun_Base::getInstance()->hasService('redirect'))
		{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/service/redirect';
	}

	public function getTable()
	{
		return Amun_Sql_Table_Registry::get('Service_Redirect');
	}
