...
class Amun_Api_Service_CommentTest extends Amun_Api_RestTest
{
	...
	{
		if(!Amun_Base::getInstance()->hasService('comment'))
		{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/service/comment';
	}

	public function getTable()
	{
		return Amun_Sql_Table_Registry::get('Service_Comment');
	}
