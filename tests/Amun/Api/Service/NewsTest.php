 ...
 */
class Amun_Api_Service_NewsTest extends Amun_Api_RestTest
{
	protected function setUp()
	{
		if(!Amun_Base::getInstance()->hasService('news'))
		{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/service/news';
	}

	public function getTable()
	{
		return Amun_Sql_Table_Registry::get('Service_News');
	}
