 ...
 */
class Amun_Api_Service_PageTest extends Amun_Api_RestTest
{
	protected function setUp()
	{
		if(!Amun_Base::getInstance()->hasService('page'))
		{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/service/page';
	}
