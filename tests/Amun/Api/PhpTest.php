 ...
 */
class PhpTest extends RestTest
{
	...
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/php';
	}

	public function getTable()
	{
		return DataFactory::getTable('Php');
	}
	...
	public function testPost()
	{
		...
		$actual = $this->table->getRow(array('pageId', 'content'), new Condition(array('id', '=', 2)));
	...
	public function testPut()
	{
		...
		$actual = $this->table->getRow(array('id', 'pageId', 'content'), new Condition(array('id', '=', 1)));
		$expect = array_map('strval', $record->getData());
