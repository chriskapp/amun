 ...
 */
class Amun_Api_System_CountryTest extends Amun_Api_RestTest
{
	public function getEndpoint()
	{
		return $this->config['psx_url'] . '/' . $this->config['psx_dispatch'] . 'api/system/country';
	}

	public function getTable()
	{
		return Amun_Sql_Table_Registry::get('System_Country');
	}
	...
	{
		$record = new Amun_System_Country($this->table);
