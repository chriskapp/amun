...
class Record extends RecordAbstract
{
	...
	{
		$title = $this->_validate->apply($title, 'string', array(new Filter\Length(3, 128), new Filter\Html()), 'title', 'Title');
	...
	public function setText($text)
	{
		...
		$text = $this->_validate->apply($text, 'string', array(new Filter\Length(3, 16384), new AmunFilter\Html($this->_registry, $this->_user)), 'text', 'Text');
