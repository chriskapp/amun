...
<div class="amun-service-forum">
	...
	<?php if(!$recordForum->isClosed()): ?>
		<?php if($user->hasRight('forum_comment_add')): ?>
			...
			<p class="muted">Please read the <a href="<?php echo $config['psx_url'] . '/' . $config['psx_dispatch'] . 'help.htm'; ?>">help</a> howto properly format your content before submitting.</p>
		<?php else: ?>
