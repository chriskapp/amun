<?php
/*
 *  $Id: Forum.php 684 2012-06-03 12:01:26Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Forum extends Amun_Data_RecordAbstract
{
	const NORMAL = 0x0;
	const STICKY = 0x1;
	const CLOSED = 0x2;
	...
	public function getReplyCount()
	{
		...
		{
			$this->_replyCount = Amun_Sql_Table_Registry::get('Service_Comment')
				->select()
	...
	public function getLastReply()
	{
		...
		{
			$this->_lastReply = Amun_Sql_Table_Registry::get('Service_Comment')
