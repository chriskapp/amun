...
namespace AmunService\Webdav\Service;

use AmunService\Webdav\RecordFile;
...
class News extends NodeAbstract
{
	public function getChildren($pageId)
	{
		...
		{
			$children[] = new RecordFile($record);
		}
