...
class Handler extends HandlerAbstract
{
	...
	{
		return $this->hm->getTable('AmunService\Oauth\Access')
			->select(array('id', 'date'))
			->join(Join::INNER, $this->hm->getTable('AmunService\Oauth')
	...
	{
		return (boolean) $this->hm->getTable('AmunService\Oauth\Access')
