...
class index extends Amun_Module_ApiAbstract
{
	...
	public function getLrdd()
	{
		try
		{
			...
			switch(true)
			{
				...
				case $record instanceof AmunService_Content_Page_Record:
	...
	private function buildAccountXrd(AmunService_User_Account_Record $account)
	{
		// subject
	...
	private function buildPageXrd(AmunService_Content_Page_Record $page)
	{
		// subject
