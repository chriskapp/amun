<?php
/*
 *  $Id: Author.php 638 2012-05-01 20:50:26Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Googleproject_Author extends Amun_Data_RecordAbstract
{
	protected $_user;
	protected $_date;
	...
	{
		$name = $this->_validate->apply($name, 'string', array(new PSX_Filter_Length(3, 32), new PSX_Filter_Html()), 'name', 'Name');
