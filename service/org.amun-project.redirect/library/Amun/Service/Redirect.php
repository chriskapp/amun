<?php
/*
 *  $Id: Redirect.php 684 2012-06-03 12:01:26Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Redirect extends Amun_Data_RecordAbstract
{
	protected $_page;
	protected $_user;
	protected $_date;
	...
	{
		return $this->_base->getUrn('service', 'redirect', $this->id);
	}
