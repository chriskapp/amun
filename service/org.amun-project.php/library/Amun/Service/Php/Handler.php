<?php
/*
 *  $Id: Handler.php 714 2012-06-18 22:23:51Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Php_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('pageId', 'content'))
		{
			$record->globalId = $this->base->getUUID('service:php:' . $record->pageId . ':' . uniqid());
