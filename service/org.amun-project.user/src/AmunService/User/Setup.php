...
class Setup extends SetupAbstract
{
	...
	public function postInstall(RecordInterface $record)
	{
		...
		{
			$this->notifyInstalledServiceInstallListener($record, new Activity\ConfigListener($this->container));
			$this->notifyInstalledServiceInstallListener($record, new Right\ConfigListener($this->container));
		}
	}
}
