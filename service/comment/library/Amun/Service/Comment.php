<?php
/*
 *  $Id: Comment.php 684 2012-06-03 12:01:26Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Comment extends Amun_Data_RecordAbstract
{
	protected $_page;
	protected $_user;
	protected $_date;
	...
	public function setText($text)
	{
		...
		$text = $this->_validate->apply($text, 'string', array(new PSX_Filter_Length(3, 2048), new Amun_Filter_HtmlPurifier($this->_config)), 'text', 'Text');
