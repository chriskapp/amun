<?php
/*
 *  $Id: Page.php 876 2012-09-30 13:55:13Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Page extends Amun_Data_RecordAbstract
{
	protected $_page;
	protected $_user;
	protected $_date;
	...
	{
		$content = $this->_validate->apply($content, 'string', array(new PSX_Filter_Length(3, 65536)), 'content', 'Content');
