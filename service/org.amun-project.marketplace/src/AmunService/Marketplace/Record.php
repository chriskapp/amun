...
namespace AmunService\Marketplace;
...
class Record extends RecordAbstract
{
	...
	{
		return $this->_base->getUrn('marketplace', $this->id);
	}
	...
	public function export(WriterResult $result)
	{
		switch($result->getType())
		{
			...
			case WriterInterface::ATOM:
				...
				$entry->setId('urn:uuid:' . $this->_base->getUUID('marketplace:' . $this->id));
				$entry->setUpdated($this->getDate());
				$entry->addAuthor($this->author);
				$entry->addLink($this->link, 'alternate', 'text/html');
