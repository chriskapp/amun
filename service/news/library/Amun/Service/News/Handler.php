<?php
/*
 *  $Id: Handler.php 684 2012-06-03 12:01:26Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_News_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('pageId', 'urlTitle', 'title', 'text'))
		{
			$record->globalId = $this->base->getUUID('service:news:' . $record->pageId . ':' . uniqid());
