 ...
 */
class Amun_Service_News_Form extends Amun_Data_FormAbstract
{
	public function create($pageId = 0)
	{
		...
		$panel = new Amun_Form_Element_Panel('news', 'News');
	...
	{
		$record = Amun_Sql_Table_Registry::get('Service_News')->getRecord($id);
