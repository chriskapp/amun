<?php
/*
 *  $Id: Table.php 875 2012-09-30 13:51:45Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Pipe_Table extends Amun_Sql_TableAbstract
{
	public function getConnections()
	{
		return array(
			...
			'mediaId' => $this->registry['table.content_media'],
	...
	{
		return $this->registry['table.service_pipe'];
	}
