<?php
/*
 *  $Id: Pipe.php 875 2012-09-30 13:51:45Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Pipe extends Amun_Data_RecordAbstract
{
	protected $_page;
	protected $_user;
	protected $_media;
	...
	{
		$mediaId = $this->_validate->apply($mediaId, 'integer', array(new Amun_Filter_Id(Amun_Sql_Table_Registry::get('Content_Media'))), 'mediaId', 'Media Id');
	...
	public function getMedia()
	{
		if($this->_media === null)
		{
			$this->_media = Amun_Sql_Table_Registry::get('Content_Media')->getRecord($this->mediaId);
		}
