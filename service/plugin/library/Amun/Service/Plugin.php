<?php
/*
 *  $Id: Plugin.php 759 2012-07-01 12:50:19Z k42b3.x@googlemail.com $
 *
 * amun
...
class Amun_Service_Plugin extends Amun_Data_RecordAbstract
{
	...
	{
		$description = PSX_Util_Markdown::decode(htmlspecialchars_decode($description, ENT_NOQUOTES));
		$description = $this->_validate->apply($description, 'string', array(new PSX_Filter_Length(3, 4096), new Amun_Filter_HtmlPurifier($this->_config)), 'description', 'Description');
