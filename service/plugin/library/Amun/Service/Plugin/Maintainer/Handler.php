<?php
/*
 *  $Id: Handler.php 696 2012-06-08 16:00:47Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class Amun_Service_Plugin_Maintainer_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('pluginId', 'userId'))
		{
