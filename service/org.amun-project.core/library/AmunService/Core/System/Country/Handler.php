 ...
 */
class AmunService_Core_System_Country_Handler extends Amun_Data_HandlerAbstract
{
	public function create(PSX_Data_RecordInterface $record)
	{
		if($record->hasFields('title', 'code', 'longitude', 'latitude'))
		{
