<?php
/*
 *  $Id: Country.php 683 2012-06-03 11:52:32Z k42b3.x@googlemail.com $
 *
 * amun
 ...
 */
class AmunService_Core_System_Country_Record extends Amun_Data_RecordAbstract
{
	...
	{
		return $this->_base->getUrn('system', 'country', $this->id);
	}
}
