 ...
 */
class AmunService_Core_System_Registry_Record extends Amun_Data_RecordAbstract
{
	const STRING  = 0x1;
	const INTEGER = 0x2;
	const FLOAT   = 0x3;
	...
	{
		$class = $this->_validate->apply($class, 'string', array(new AmunService_Core_System_Registry_Filter_Class()), 'class', 'Class');
