 ...
 */
class AmunService_Core_System_Connect_Access_Record extends Amun_Data_RecordAbstract
{
	protected $_user;
	protected $_returnTo;
	protected $_date;
	...
	public function getReturnTo()
	{
		...
		{
			$this->_returnTo = new PSX_Url($this->returnTo);
		}
