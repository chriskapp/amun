...
/**
 * AmunService_Core_System_Api_Request_Handler
 *
 ...
 */
class AmunService_Core_System_Api_Request_Handler extends Amun_Data_HandlerAbstract
{
	...
	{
		throw new PSX_Data_Exception('Requests can not updated');
	}
