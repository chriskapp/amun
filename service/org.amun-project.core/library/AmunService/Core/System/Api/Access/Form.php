...
/**
 * AmunService_Core_System_Api_Access_Form
 *
 ...
 */
class AmunService_Core_System_Api_Access_Form extends Amun_Data_FormAbstract
{
	...
	{
		$record = Amun_Sql_Table_Registry::get('Core_System_Api_Access')->getRecord($id);
