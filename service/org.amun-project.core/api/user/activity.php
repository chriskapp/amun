<?php
/*
 *  $Id: activity.php 743 2012-06-26 19:31:26Z k42b3.x@googlemail.com $
 *
 * amun
	...
	protected function setWriterConfig(PSX_Data_WriterResult $writer)
	{
		switch($writer->getType())
		{
			case PSX_Data_WriterInterface::ATOM:
				...
				$updated = $this->sql->getField('SELECT `date` FROM ' . $this->registry['table.core_user_activity'] . ' ORDER BY `date` DESC LIMIT 1');
