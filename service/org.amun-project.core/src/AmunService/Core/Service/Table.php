...
class Table extends TableAbstract
{
	...
	{
		return $this->registry['table.core_service'];
	}
	...
	public function getColumns()
	{
		return array(
			...
			'source' => self::TYPE_VARCHAR | 255,
			'autoloadPath' => self::TYPE_VARCHAR | 255,
			'config' => self::TYPE_VARCHAR | 255,
			'name' => self::TYPE_VARCHAR | 64,
			'path' => self::TYPE_VARCHAR | 255,
			'namespace' => self::TYPE_VARCHAR | 64,
			'type' => self::TYPE_VARCHAR | 255,
			'link' => self::TYPE_VARCHAR | 255,
			'license' => self::TYPE_VARCHAR | 255,
